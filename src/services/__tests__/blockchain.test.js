...
describe('blockchain service', () => {
  ...
  describe('getAccountInfo', () => {
    test('should validate account name', async () => {
      ...
      await expect(getAccountInfo(null, 'testnet')).rejects.toThrow(
        ValidationError
      );
    ...
    test('should validate network', async () => {
      await expect(getAccountInfo('testaccount', 'invalid')).rejects.toThrow(
        ValidationError
      );
    });
  ...
  describe('getBlockProducers', () => {
    test('should validate network', async () => {
      await expect(getBlockProducers('invalid')).rejects.toThrow(
        ValidationError
      );
    });
  ...
  describe('getVoteInfo', () => {
    test('should validate inputs', async () => {
      ...
      await expect(getVoteInfo('testaccount', 'invalid')).rejects.toThrow(
        ValidationError
      );
    });
  ...
  describe('checkVotingResources', () => {
    test('should validate inputs', async () => {
      ...
      await expect(
        checkVotingResources('testaccount', 'invalid')
      ).rejects.toThrow(ValidationError);
    });
  ...
  describe('getCurrencyBalance', () => {
    test('should validate inputs', async () => {
      ...
      await expect(
        getCurrencyBalance('testaccount', 'XPR', 'invalid')
      ).rejects.toThrow(ValidationError);
    });
  ...
  describe('getCoreSymbol', () => {
    test('should validate network', async () => {
      await expect(getCoreSymbol('invalid')).rejects.toThrow(ValidationError);
    });
